...
<link href='http://fonts.googleapis.com/css?family=Exo+2:900italic&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
{literal}

<style type="text/css">
		/*Demo - Social Icons*/
		.widgets-field .social-icon {
			background-image: url(images/demo/social-icons.png);
